...
- `admin.html` – admin zóna chránená Firebase Authentication (email + heslo):
  - nastavenie 5 termínov workshopu (dátum a čas, kapacita pevne 10)
  - tabuľka všetkých prihlásených s vyhľadávaním, filtrom podľa termínu a **exportom do CSV**
  - štatistiky: obsadenosť termínov, priemerné skóre vstup/výstup, zdroje info, skúsenosti s AI (grafy cez Chart.js)
